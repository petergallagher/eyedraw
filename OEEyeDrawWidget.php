...
class OEEyeDrawWidget extends CWidget
{
	...
	*/
	...
	protected function registerScripts()
	{
		...
		// Register the EyeDraw scripts
		$cs->registerScriptFile($this->jsPath.'/oe_eyedraw.min.js', CClientScript::POS_HEAD);
		$cs->registerScriptFile($this->jsPath.'/eyedraw.min.js', CClientScript::POS_HEAD);
	...
	{
		$cssFile = $this->cssPath.'/oe_eyedraw.css';
