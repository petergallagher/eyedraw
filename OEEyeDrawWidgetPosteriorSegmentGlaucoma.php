...
class OEEyeDrawWidgetPosteriorSegmentGlaucoma extends OEEyeDrawWidget {

    public $doodleToolBarArray = array('Geographic', 'VitreousOpacity', 
        'DiabeticNV', 'CNV', 'Circinate');
    ...
    public function init() {
        if ($this->mode == 'view') {
            ...
            $this->onLoadedCommandArray = array(array('addDoodle', 
                array('PostPole')), array('deselectDoodles', array()));
        } else {
